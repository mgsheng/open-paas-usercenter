...
import cn.com.open.openpaas.userservice.web.api.user.SessionDestoryController;
import cn.com.open.openpaas.userservice.web.api.user.SessionVerifyController;
...
public class TestRemoveSessionControler {
	...
	// 注入sessionDestoryController
	@Autowired
	private SessionDestoryController sessionDestoryController;
	@Autowired
	...
	/**
	 * 
	 * @Title：testRemoveSession
	 * @Description: 测试验证session
	 */
	@Test
