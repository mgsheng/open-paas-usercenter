...
public class TestAutoLoginControler {
	...
	public void testAutoLogin() {
		try {		
			String key=PropertiesTool.getAppPropertieByKey("credentials-client");
	   	    ...
	   	    String secret=DESUtil.encrypt("123#20170330135700#credentials-client#123456#http://www.baidu.com", "credenti");/*Des(（sourceId+“#”+time+“#”+appKey+“#”+salt+“#”+desAddress）, appSecret)*/
		    if(key!=null){
