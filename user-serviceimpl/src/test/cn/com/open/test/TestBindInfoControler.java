...
public class TestBindInfoControler {
	...
	// 注入userCenterBindInfoController
	@Autowired
	private UserCenterBindInfoController userCenterBindInfoController;
	@Autowired
	 ...
	 * 
	 * @Title：testBindInfo
	 * @Description: 测试绑定用户信息
	 */
	@Test
	public void testBindInfo() {
		try {		
			...
			MvcResult result = mockMvc.perform(
					MockMvcRequestBuilders.get("/user/bindUserInfo")
