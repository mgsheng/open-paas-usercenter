...
import cn.com.open.openpaas.userservice.web.api.user.UserCenterUnBindController;
...
public class TestUnBindControler {
	...
	// 注入userCenterUnBindController
	@Autowired
	private UserCenterUnBindController userCenterUnBindController;
	@Autowired
	...
	public void testUnBind() {
		try {		
			...
			MvcResult result = mockMvc.perform(
					MockMvcRequestBuilders.get("/user/unBindUser")
