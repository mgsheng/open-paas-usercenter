...
public class UserCenterModiPwdTest {
    ...
    public void userCenterModiPwd() {
        try {
            ...
            MvcResult result = mockMvc.perform(
                MockMvcRequestBuilders.post("/user/userCenterModiPwd")
                    .param("timestamp", timestamp)
                    .param("signatureNonce", signatureNonce)
                    .param("access_token", accessToken)
                    .param("client_id", clientId)
                    .param("signature", signature)
                    .param("account", Common.USERNAME)
                    .param("old_pwd", AESUtil.encrypt(Common.PASSWORD, Common.CLIENT_SECRET))
                    .param("new_pwd", AESUtil.encrypt(Common.PASSWORD + "11", Common.CLIENT_SECRET))).andReturn();
            ...
            MvcResult result1 = mockMvc.perform(
                MockMvcRequestBuilders.post("/user/userCenterModiPwd")
                    ...
                    .param("signature", signature)
                    .param("account", Common.USERNAME)
                    .param("new_pwd", AESUtil.encrypt(Common.PASSWORD, Common.CLIENT_SECRET))
                    .param("old_pwd", AESUtil.encrypt(Common.PASSWORD + "11", Common.CLIENT_SECRET))).andReturn();
