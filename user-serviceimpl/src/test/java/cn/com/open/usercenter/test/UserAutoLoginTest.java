...
public class UserAutoLoginTest {
    ...
    @Test
    public void userCenterCheckTokenTest() {
        try {
            ...
            MvcResult result = mockMvc.perform(
                MockMvcRequestBuilders.post("/user/autoLogin")
                    .param("timestamp", timestamp)
                    .param("signatureNonce", signatureNonce)
                    .param("access_token", accessToken)
                    .param("client_id", clientId)
                    .param("secret", DES.encrypt(Common.SOURCE_ID + "#" + DateTools.dateToString(new Date(),"yyyyMMddHHmmss") + "#" + Common.CLIENT_ID + "#123456", Common.CLIENT_SECRET))
                    .param("signature", signature)).andReturn();
