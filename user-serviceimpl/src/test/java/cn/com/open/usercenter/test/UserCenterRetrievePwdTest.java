...
public class UserCenterRetrievePwdTest {
    ...
    public void userCenterRetrievePwdTest() {
        try {
            ...
            MvcResult result = mockMvc.perform(
                MockMvcRequestBuilders.post("/user/userCenterRetrievePwd")
                    .param("timestamp", timestamp)
                    .param("signatureNonce", signatureNonce)
                    .param("access_token", accessToken)
                    .param("client_id", clientId)
                    .param("signature", signature)
                    .param("guid", Common.GUID)
                    .param("username", Common.USERNAME)
                    .param("new_pwd", AESUtil.encrypt(Common.PASSWORD, Common.CLIENT_SECRET))).andReturn();
