			...
			<div class="w_1200">
				<div class="getbackpwd">
					<div class="stepbar">
						...
						<div class="second curr "><span class="num">2</span>选择密码找回方式</div>
						<div class="four"><span class="num">3</span>验证身份</div>
						<div class="third"><span class="num">4</span>修改密码</div>
					</div>
					<div class="getbackchoice">
							<div class="phone"><a href="${pageContext.request.contextPath}/findpwdphone?guid=${guid}"><span class="txtchoice">用绑定手机找回</span></a></div>
						    <div class="email"><a href="${pageContext.request.contextPath}/findpwdemail?guid=${guid}"}><span class="txtchoice">用绑定邮箱找回</span></a></div>
