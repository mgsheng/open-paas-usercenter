...
import cn.com.open.openpaas.userservice.web.api.user.UserCenterRetrievePwdController;
...
public class TestRetrievePwdControler {
	...
	// 注入UserCenterRetrievePwdController
	@Autowired
	private UserCenterRetrievePwdController userCenterRetrievePwdController;
	@Autowired
	...
	/**
	 * 
	 * @Title：testRetrievePwd
	 * @Description: 测试找回密码
	 */
	@Test
	public void testRetrievePwd() {
		try {		
			...
			MvcResult result = mockMvc.perform(
					MockMvcRequestBuilders.get("/user/userCenterRetrievePwd")
