...
import cn.com.open.openpaas.userservice.web.api.user.CheckTokenController;
...
public class TestCheckTokenControler {
	...
	public void testCheckToken() {
		try {		
			...
			MvcResult result = mockMvc.perform(
					MockMvcRequestBuilders.get("/user/userCenterCheckToken")
