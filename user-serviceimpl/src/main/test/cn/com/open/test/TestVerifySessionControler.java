...
public class TestVerifySessionControler {
	...
	// 注入sessionVerifyController
	@Autowired
	private SessionVerifyController sessionVerifyController;
	@Autowired
	...
	public void testVerifySession() {
		try {		
			...
			MvcResult result = mockMvc.perform(
					MockMvcRequestBuilders.get("/user/session/verify")
