...
import cn.com.open.openpaas.userservice.web.api.user.UserCenterSaveInfoController;
...
public class TestSaveUserInfoControler {
	...
	// 注入userCenterSaveInfoController
	@Autowired
	private UserCenterSaveInfoController userCenterSaveInfoController;
	@Autowired
	...
	public void testSaveInfo() {
		try {		
			...
			MvcResult result = mockMvc.perform(
					MockMvcRequestBuilders.get("/user/saveUserInfo")
							.param("client_id", "credentials-client")
							.param("access_token", "11c6cc8f-7d93-4c29-a161-7d95e2572365")
							.param("source_id", "1234")
							.param("username", "xiaoli1234")
