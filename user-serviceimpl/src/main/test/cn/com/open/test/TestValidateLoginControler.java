...
import cn.com.open.openpaas.userservice.web.api.user.ValidateLoginController;
...
public class TestValidateLoginControler {
	...
	public void testValidateLogin() {
		try {		
			String key=PropertiesTool.getAppPropertieByKey("credentials-client");
	   	    ...
	   	    String secret="123#20170330093600#credentials-client";/*AES加密之后的验证信息 格式：sourceId+“#”+time+“#”+appKey*/
		    if(key!=null){
			...
			MvcResult result = mockMvc.perform(
					MockMvcRequestBuilders.get("/user/validateLogin")
							.param("client_id", "credentials-client")
							.param("access_token", "11c6cc8f-7d93-4c29-a161-7d95e2572365")
							.param("secret", secret)/*AES加密之后的验证信息 格式：sourceId+“#”+time+“#”+appKey*/
