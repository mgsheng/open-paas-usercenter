...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="verifySession" method="post" class="form-horizontal">
                <input type="hidden" name="verifySessionUri" value="${verifySessionUri}"/>
                ...
                <br/>
                 <br/>
                <button type="submit" class="btn btn-primary" >调用用户Session验证接口</button>
