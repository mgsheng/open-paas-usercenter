...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action=userCentergetValidationRule method="post" class="form-horizontal">
                <input type="hidden" name="getValidationRuleUri" value="${getValidationRuleUri}"/>
                ...
                <div ng-show="visible">
                 ...
                 <div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="col-sm-2 control-label">pwdRule</label>

                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="pwdRule" required="required"
                                       ng-model="pwdRule"/>

                                <p class="help-block">用户密码规则</p>
                            </div>
                        </div>
...
<script>
    var AuthorizationCodeCtrl = ['$scope', function ($scope) {
        $scope.getValidationRuleUri = '${getValidationRuleUri}';
     ...
     function btnSubmit(){
				...
				var pwdRule=$("input[name='pwdRule']").val();
	   			var getValidationRuleUri=$("input[name='getValidationRuleUri']").val();
				if(clientId==''){
				    alert("请输入clientId");
					return;
				}if(accessToken==''){
					...
					accessToken:accessToken,
	   				...
	   				function(data){
	   					if(data.flag){
	   					    ...
	   					    var regUri=getValidationRuleUri+"?&client_id="+clientId+"&access_token="+accessToken+"&pwdRule="+pwdRule+"&signature="+signature+"&amptimestamp="+timestamp+"&signatureNonce="+signatureNonce;
	   						$("#regUri").html(regUri);
	   					}
	   					else{
