...
<html>
<head>
    <title>bindUserInfo(interface)</title>
    ...
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="bindUserInfo" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <p class="help-block">用户中心的用户唯一id  <font color="red">(必传)</font></p>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <br/>
                 <br/>
                <button type="submit" class="btn btn-primary" >调用用户信息绑定接口</button>
...
<script>
    var AuthorizationCodeCtrl = ['$scope', function ($scope) {
        $scope.bindUserInfo = '${bindUserInfo}';
     ...
     function btnSubmit(){
				...
				var accessToken=$("input[name='access_token']").val();
	   			...
	   			var bindUserInfoUri=$("input[name='bindUserInfo']").val();
	   			var sourceId=$("input[name='source_id']").val();
					...
					accessToken:accessToken,
	   				...
	   				function(data){
	   					if(data.flag){
	   					    ...
	   					    var regUri=bindUserInfoUri+"?client_id="+clientId+"&guid="+guid+"&grant_type="+grantType+"&scope="+scope+"&access_token="+accessToken+"&source_id="+sourceId+"&phone="+phone+"&email="+email+"&signature="+signature+"&amptimestamp="+timestamp+"&signatureNonce="+signatureNonce;
	   						$("#regUri").html(regUri);
	   					}
	   					else{
