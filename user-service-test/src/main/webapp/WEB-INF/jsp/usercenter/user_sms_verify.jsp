...
<html>
<head>
    <title>user-sms-verify(interface)</title>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="smsVerify" method="post" class="form-horizontal">
            <%-- <form action="${userCenterRegUri}" method="post" class="form-horizontal"> --%>
                <input type="hidden" name="userSmsVerify" id="userSmsVerify" value="${userSmsVerify}"/>
               ...
               <div ng-show="visible">
					...
					<div class="form-group">  
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="code" size="50" id="code" class="form-control"
                                   ng-model="code"/>
                ...
                <br/>
                <br/>
                <button type="submit" class="btn btn-primary">调用验证码验证接口</button>
...
<script>
    var AuthorizationCodeCtrl = ['$scope', function ($scope) {
        ...
        $scope.userSmsVerify = '${userSmsVerify}';
...
<script type="text/javascript">
	function btnSubmit(){
				...
				var scope=$("#scope").val();
	   			var code=$("#code").val();
	   			var phone=$("#phone").val();
	   			var userSmsVerify=$("#userSmsVerify").val();
					...
					accessToken:accessToken,
	   				...
	   				function(data){
	   					if(data.flag){
	   					    ...
	   					    var regUri=userSmsVerify+"?"+"client_id="+clientId+"&access_token="+accessToken+"&code="+code+"&phone="+phone+"&signature="+signature+"&amptimestamp="+timestamp+"&signatureNonce="+signatureNonce;
	   						$("#regUri").html(regUri);
	   					}
	   					else{
