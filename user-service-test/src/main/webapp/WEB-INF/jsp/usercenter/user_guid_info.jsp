...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="userGuidInfo" method="post" class="form-horizontal">
                <input type="hidden" name="userGuidInfoUri" value="${userGuidInfoUri}"/>
...
<script>
    var AuthorizationCodeCtrl = ['$scope', function ($scope) {
        $scope.userGuidInfoUri = '${userGuidInfoUri}';
     ...
     function btnSubmit(){
				...
				var accessToken=$("input[name='access_token']").val();
	   			...
	   			var userGuidInfoUri=$("input[name='userGuidInfoUri']").val();
				if(clientId==''){
				    alert("请输入clientId");
					return;
				}if(accessToken==''){
					...
					accessToken:accessToken,
	   				...
	   				function(data){
	   					if(data.flag){
	   					    ...
	   					    var regUri=userGuidInfoUri+"?&client_id="+clientId+"&access_token="+accessToken+"&account="+account+"&accountType="+accountType+"&signature="+signature+"&amptimestamp="+timestamp+"&signatureNonce="+signatureNonce;
	   						$("#regUri").html(regUri);
	   					}
	   					else{
