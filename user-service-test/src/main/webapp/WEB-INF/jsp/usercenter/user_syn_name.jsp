...
<html>
<head>
    <title>synUserName(interface)</title>
</head>
<body>
...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="synUserName" method="post" class="form-horizontal">
            <%-- <form action="${synUserInfo}" method="post" class="form-horizontal"> --%>
                <input type="hidden" name="synUserNameUri" value="${synUserNameUri}"/>
                ...
                <br/>
                 <br/>
                <button type="submit" class="btn btn-primary" >调用用户名同步接口</button>
                <%--
