...
<html>
<head>
    <title>UserCenterResetPwd</title>
</head>
<body>
...
<div class="panel panel-default">
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="userCenterResetPwd" method="post" class="form-horizontal">
                <input type="hidden" name="userCenterResetPwdUri" value="${userCenterResetPwdUri}"/>
                ...
                <div ng-show="visible">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="username" size="50" class="form-control" required="required"
                                   ng-model="username"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="phone_email" required="required"
                                   ng-model="phoneEmail"/>

                            <p class="help-block">用户中心用户手机或邮箱</p>
                        </div>
                    </div>
                    <div class="well well-sm">
                        ...
                        <div class="text-primary">
                            {{userCenterResetPwdUri}}?accessToken={{accessToken}}&username={{username}}&phone_email={{phoneEmail}}
                        </div>
                    </div>
                </div>
                <br/>
