...
<html>
<head>
    <title>user-center-reg(interface)</title>
    ...
    <div class="panel-body">
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <%-- <form action="${userCenterRegUri}" method="post" class="form-horizontal"> --%>
                <input type="hidden" name="userCenterRegUri" id="userCenterRegUri" value="${userCenterRegUri}"/>
                ...
                <br/>
                <br/>
                <button type="submit" class="btn btn-primary">调用注册接口</button>
...
<script>
    var AuthorizationCodeCtrl = ['$scope', function ($scope) {
        ...
        $scope.userCenterRegUri = '${userCenterRegUri}';
